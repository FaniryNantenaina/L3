...
router.post('/save', (req, res) => {
    ...
    connection.query(sql2, (err2, rows) => {
        ...
        if(rows.length > 0){
            ...
            let dataM = {CodeMatiere: req.body.cd, Designation: req.body.design};
...
router.post('/update', (req, res) => {
    ...
    let sql = "UPDATE matiere SET CodeMatiere ='"+req.body.cd+"', Designation ='"+req.body.design+"' WHERE CodeMatiere ='"+cdMatiere+"' ";
